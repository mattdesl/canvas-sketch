 ...
 * @param {Array|String} settings.dimensions - The dimensions of your sketch in [width, height] units. If not specified, the sketch will fill the browser window. You can also specify a preset string such as "A4" or "Letter".
 * @param {String} settings.units - The working units if dimensions is specified, can be "in", "cm", "px", "ft", "m", "mm".
